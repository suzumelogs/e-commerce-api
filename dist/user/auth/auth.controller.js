...
const user_decrator_1 = require("../decorators/user.decrator");
...
let AuthController = exports.AuthController = class AuthController {
    ...
    async login(body) {
        return this.authService.validateUserFromEmailPassword(body.email, body.password);
    }
    async signup(body) {
        return this.authService.signupWithEmailPassword(body.email, body.displayName, body.password);
    }
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [auth_dto_1.SingupDTO]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [auth_dto_1.RestPasswordDTO]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [auth_dto_1.UpdatePasswordDTO]),
    __metadata("design:returntype", Promise)
